...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2>Form Tambah Kriteria Penilaian</h2>
        </template>
                    ...
                    <div class="flex">
                        <fieldset :class="showSub ? 'w-[60%]' : 'w-full'"
                            ...
                            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                                ...
                                <div class="col-span-full">
                                    <InputLabel for="persentase" value="Persentase Kriteria" />

                                    <TextInput id="persentase" type="number" placeholder="Persentase Kriteria"
                                        v-model="Form.persentase" class="w-full text-gray-900" />
                                    <InputError :message="Form.errors.persentase" />
                                </div>
                                <div class="col-span-full">
                                    <InputLabel for="bobot" value="Bobot Kriteria Penilaian" />
